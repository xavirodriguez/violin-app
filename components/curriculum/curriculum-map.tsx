...
export function CurriculumMap() {
  ...
  const t = useTranslation(language).curriculum
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-12 py-8">
      <div className="space-y-2 text-center">
        <h1 className="text-4xl font-bold tracking-tight">{t.roadmapTitle}</h1>
        ...
        <div className="space-y-4 rounded-xl border bg-card p-6 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-medium text-muted-foreground">
              {completedCount}/{unit.lessons.length} {t.lessons}
            </span>
          </div>
          ...
          {unit.learningObjectives.length > 0 && (
            <div className="border-t pt-4">
              <h4 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2">{t.objectives}</h4>
