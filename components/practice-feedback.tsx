...
interface PracticeFeedbackProps {
  /** The target note the student should play (e.g., "A4") */
  targetNote: string | null
  /** The note name currently being detected (e.g., "G4") */
  detectedPitchName?: string | null
  /** Deviation from the target pitch in cents */
  centsOff?: number | null
  /** Current status of the practice session */
  status: string
  /** Technical observations generated in real-time */
  liveObservations?: Observation[]
}

/**
 * Provides hierarchical visual feedback for the practice session.
 *
 * Hierarchy:
 * 1. Primary: Big visual indicator of correctness/intonation.
 * 2. Secondary: Target vs Detected pitch names.
 * 3. Tertiary: Collapsible technical metrics (cents, tolerance).
 * 4. Contextual: Actionable live observations.
 */
export function PracticeFeedback({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* LEVEL 1: Primary State - Visual feedback on intonation/correctness */}
      ...
      {/* LEVEL 2: Technical Metrics - Collapsed by default */}
      ...
      {/* LEVEL 3: Live Observations - Actionable feedback */}
