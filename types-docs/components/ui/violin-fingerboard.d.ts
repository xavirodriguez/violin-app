 ...
 */
export declare function ViolinFingerboard({ targetNote, detectedPitchName, centsDeviation, centsTolerance, }: ViolinFingerboardProps): import("react/jsx-runtime").JSX.Element;
export {};
